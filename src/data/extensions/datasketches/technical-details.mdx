...
<div class="flex items-center gap-4 mb-8 not-prose">
  ...
  <div>
    ...
    <p class="text-lg text-soil-700">Mergeable, persistable streaming sketches — distinct counts, quantiles, and heavy hitters — from the <a href="https://datasketches.apache.org/" class="text-sun-700 underline underline-offset-2 decoration-sun-300 hover:decoration-sun-700">Apache DataSketches</a> library.</p>
  </div>
</div>
