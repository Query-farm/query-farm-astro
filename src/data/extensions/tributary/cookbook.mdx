...
<div class="flex items-center gap-3 mb-6 not-prose text-soil-600">
  ...
  <p class="text-sm">Recipes for <a href="https://kafka.apache.org/" class="text-sun-700 underline underline-offset-2 decoration-sun-300 hover:decoration-sun-700">Apache Kafka</a> read paths, JSON decoding, joins, and discovery.</p>
</div>
