...
import { loadFunctions } from '../../extension-data-loader';
...
const metadata: ExtensionMetadata = {
  ...
  cta: {
    ...
    description: 'This example extension demonstrates all available features for extension documentation.'
  },
  license: 'MIT',
  pricing: 'paid',
  ...
  binarySize: '2.4 MB',
  writtenIn: 'C++',
  sourceAvailable: 'https://github.com/Query-farm/duckdb-example',
  dependencies: [],
  usageStats: {
    count: 12500,
    period: 'last 30 days'
  ...
  image: '/images/extensions/example.svg'
};


// Load and validate functions from JSON
const functions = loadFunctions(functionsJson, 'extensions/example/functions.json');
