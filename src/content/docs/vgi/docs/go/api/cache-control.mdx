---
title: "Cache control"
description: "Advertising a result as reusable by the client, via the CacheControl struct."
---
...
Advertising a result as reusable by the client, via the CacheControl struct.
