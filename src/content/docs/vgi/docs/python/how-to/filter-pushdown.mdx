...
- **Demand a filter rather than accept one** → [Requiring filters on a
  scan](/vgi/docs/python/how-to/catalog-interface/#requiring-filters-on-a-scan).
- **The decoded API** → [API Reference: table_filter_pushdown](/vgi/docs/python/api/vgi-table_filter_pushdown/).
