...
import { exportFunction, jsonResponse } from '@haybarn/lib/agent-docs';
...
export const GET: APIRoute = ({ props }) => jsonResponse(exportFunction(props.snapshot as Snapshot, props.fn as FunctionDoc));
